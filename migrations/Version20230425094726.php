 ...
 */
final class Version20230425094726 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE current_session (id INT IDENTITY NOT NULL, session_id INT NOT NULL, institution_id INT NOT NULL, number_of_exam INT, skills NVARCHAR(50), status NVARCHAR(30) NOT NULL, PRIMARY KEY (id))');
